...
namespace CmCapitalDevSrProject.Migrations
{
    ...
    public partial class FirstMigration : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                name: "InteressesProdutosFuturos",
                columns: table => new
                {
                    Id = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_InteressesProdutosFuturos", x => x.Id);
                    table.ForeignKey(
                        name: "FK_InteressesProdutosFuturos_Categorias_CategoriaId",
                        column: x => x.CategoriaId,
                        principalTable: "Categorias",
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_InteressesProdutosFuturos_Clientes_ClienteId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_InteressesProdutosFuturos_CategoriaId",
                table: "InteressesProdutosFuturos",
                column: "CategoriaId");

            migrationBuilder.CreateIndex(
                name: "IX_InteressesProdutosFuturos_ClienteId",
                table: "InteressesProdutosFuturos",
                column: "ClienteId");
